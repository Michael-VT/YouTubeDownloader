...
У репозиторії нічого не зберігається: запуск віддає лише сам медіафайл (mp4/mp3) у вигляді нетривалого артефакту (1 доба). Завантажте zip із підсумку запуску; за транскрипцією та журналом запускайте програму локально.
