...
Порада: у форми запуску є постійна адреса — `https://github.com/ВАШ_ЛОГІН/ВАШ_РЕПОЗИТОРІЙ/actions/workflows/download.yml` (додайте в закладки). Позначте у формі **publish**, щоб прикріпити файли до GitHub **Release** — постійної сторінки з прямими посиланнями на завантаження (див. *Releases* у репозиторії або посилання у підсумку запуску). Це правильний спосіб зберігати файли «в репозиторії»: комітити відео в git-історію не можна — вона розпухне, а GitHub і так блокує файли понад 100 МБ.
